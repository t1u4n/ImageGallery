...
const getImages = () => {
  return [
    { src: '/greenday.gif', width: 800, height: 600 },
    { src: '/gunnrose.webp', width: 500, height: 400 },
    { src: '/iu.gif', width: 800, height: 600 },
    { src: '/concert1.avif', width: 800, height: 600 },
    { src: '/concert2.avif', width: 800, height: 600 },
  ];
};
