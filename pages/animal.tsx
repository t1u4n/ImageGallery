...
const getImages = () => {
  return [
    { src: '/dog1.webp', width: 800, height: 600 },
    { src: '/husky1.avif', width: 500, height: 400 },
    { src: '/cat1.webp', width: 500, height: 400 },
    { src: '/whale1.webp', width: 500, height: 400 },
    { src: '/lion1.gif', width: 500, height: 400 },
  ];
};
